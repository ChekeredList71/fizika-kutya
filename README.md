...
Az oldalt található *Releases* résznél vannak/lesznek a .zip fájlok, amik tartalmazzák a lefordított programot, egy indítóprogramot és a .jar fájl futtatásához szükséges JDK-t is. Ott kell letölteni a fizika-kutya-*verziószám*.zip fájt.
